...
//
@interface Image : RenderedObject {
...
@property(nonatomic) GLenum blendDFactor;
@property(nonatomic) GLenum blendSFactor;
...
//Get and set the alpha component of the colour filter for this image.
